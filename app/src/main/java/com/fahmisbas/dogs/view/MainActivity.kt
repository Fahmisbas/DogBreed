...
import com.fahmisbas.dogs.util.PERMISSION_SEND_SMS
...
class MainActivity : AppCompatActivity() {
    ...
    private fun notifyDetailFragment(perimissionGranted: Boolean) {
        val activeFragment = fragment.childFragmentManager.primaryNavigationFragment
        if (activeFragment is DetailFragment) {
            (activeFragment as DetailFragment).onPermissionResult(perimissionGranted)
        }
    }
